...
const CardInfomation = () => {
  return (
    <Box px="8" py="6" w="fit-content" ml="auto" textAlign="center" bg="white" transform="translateY(-30%)" borderRadius="2xl" boxShadow="xl">
        <Flex flexDirection="column" align="center">
            <Box w="36" h="36" borderRadius="full" overflow="hidden" position="relative" mb="5">
