  ...
  return (
    <Box border="2px solid #8682A7" borderRadius="lg">
        <FormControl p="4" as="form" onSubmit={handleSubmit}>
            <Textarea value={descValue?.descValue} onChange={handleChange}   mb="5" placeholder='nhập đi' resize="none" h="32" size="md"/>
            <Flex justify="flex-end" gap="3">
                <Button type='submit' borderRadius="lg">Update</Button>
                <Button onClick={()=>props.setShow(false)} type='submit' borderRadius="lg">Cancel</Button>
            </Flex>
        </FormControl>
    </Box>
  )
